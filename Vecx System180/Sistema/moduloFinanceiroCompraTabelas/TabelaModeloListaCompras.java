...
public class TabelaModeloListaCompras extends AbstractTableModel{
	...
	/*Nome das colunas*/
    private String[] colunas = {"Codigo do produto","Nome do produto","Quantidade","Preço","Data de compra",""};
    
    
    public TabelaModeloListaCompras() {
