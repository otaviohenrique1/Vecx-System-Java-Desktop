...
import moduloTransporteBD.Dao_alterar_dados_transporte;
import moduloTransporteBD.Dao_consulta_dados_transportecarga;
import moduloTransporteBD.TransporteCarga;

public class Controle_de_Cargas_Ficha_Editar extends JFrame {
	...
	Dao_alterar_dados_transporte salvaNovosDados;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Controle_de_Cargas_Ficha_Editar frame = new Controle_de_Cargas_Ficha_Editar();
	 ...
	 * Create the frame.
	 */
	public Controle_de_Cargas_Ficha_Editar() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Controle_de_Cargas_Ficha_Editar.class.getResource("/cImagens/Logo Janela.PNG")));
		...
		icone.setIcon(new ImageIcon(Controle_de_Cargas_Ficha_Editar.class.getResource("/cImagens/Editar.PNG")));
		...
		JComboBox<String> comboBoxEstadoCarga = new JComboBox<String>();
    	...
    	for (TransporteCarga leitura : Consulta) {
    		...
    		comboBoxEstadoCarga.setSelectedItem(estadoCargaTexto);
		...
		salvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (comboBoxEstadoCarga.getSelectedItem() == "Selecione") {
					...
					cadastrarTransporteCarga.setCodigoTransporte(codigoTransporte.getText());
					cadastrarTransporteCarga.setClienteNome(nomeCliente.getText());
					cadastrarTransporteCarga.setClienteCPF(clienteCPF.getText());
					salvaNovosDados = new Dao_alterar_dados_transporte();
					salvaNovosDados.Altera_Dados_Cliente(cadastrarTransporteCarga);
					...
					Controle_de_Cargas_Ficha abrirTelaControleCargasFicha = new Controle_de_Cargas_Ficha();
					abrirTelaControleCargasFicha.setVisible(true);
					dispose();
				}
			}
		});
